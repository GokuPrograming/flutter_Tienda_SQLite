...
class DropdownMunicipioCarWidget extends StatefulWidget {
  //recibe el modelo de municipio
  final Function(MunicipioModel?) onChanged;
  final int? id_comunidad;
  const DropdownMunicipioCarWidget(
    this.id_comunidad,
      {super.key, required this.onChanged});

  @override
  State<DropdownMunicipioCarWidget> createState() =>
      _DropdownComunidadWidgetState();
}

class _DropdownComunidadWidgetState extends State<DropdownMunicipioCarWidget> {
